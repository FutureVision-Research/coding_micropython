# This script communicates with an ADXL345 accelerometer and diplays its information onto the Shell.
# Note this receives the "raw" readings from the accelerameter. In order to be useful, this information must be calibrated.
# However, that is outside the scope of this activity.
